...
function Equipe() {
    ...
    return (
        <>
            <section id="equipe-section" className="bg-[#a6bbc875] mt-14">
                <div className="container py-16">
                    <div className="head-wrap">
                        ...
                        <p className="mt-3 text-gray-500 text-[16px]">
                            Nous sommes des éducateurs, chercheurs, designers pédagogiques et créateurs passionnés.<br/>
                            Ensemble, nous concevons des ressources innovantes et des expériences d’apprentissage<br/>
                            centrées sur l’apprenant, favorisant l’exploration, la créativité et la pensée critique.
                        </p>
                    </div>
