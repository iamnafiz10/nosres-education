                        ...
                        <div data-aos="zoom-in" data-aos-duration="1000"
                            ...
                            <div className="block md:flex items-start gap-8 z-20">
                                <h4 className="text-[24px] font-semibold text-black">
                                    Rejoignez Nosres laboratoire éducatif et
                                    contribuezà innover pour une éducation
                                    plus créative et inclusive.
                                </h4>
                                <div className="right_side mt-4 md:mt-0">
                                    <h4 className="text-[16px] leading-5">
                                        Vous souhaitez collaborer avec Nosres laboratoire
                                        éducatif, tester nos projets ou en savoir plus ?
                                    </h4>
                                    <div className="flex items-center gap-2 mt-2">
                                        <div className="icon">
                                            <LuMail size={15} className="text-primary"/>
                                        </div>
                                        <h4 className="text-[14px] text-graycolor">lab@nosres.com</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
